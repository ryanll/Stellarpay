      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <div className="mt-6 pt-6 border-t border-slate-800 text-center text-sm text-slate-500">
            Demo account: <span className="text-slate-300 font-mono">demo@stellarpay.dev</span> / <span className="text-slate-300 font-mono">password123</span>
          </div>
        </div>

        <p className="text-center text-sm text-slate-500 mt-6">
          Don&apos;t have an account?{' '}
          <Link href="/auth/signup" className="text-stellar-400 hover:text-stellar-300">Create one free →</Link>
        </p>
      </div>
    </div>
  )
